...
// MERN + Full Stack Tech Stack (Based on Resume)
const techStack: TechItem[][] = [
  ...
  [
    ...
    { name: "LoopBack", icon: "https://loopback.io/images/global/loopback-mark-frame-white.svg", url: "https://loopback.io" },
  ],
  ...
  [
    ...
    { name: "REST APIs", icon: "https://img.icons8.com/color/96/api-settings.png", url: "https://restfulapi.net/" },
  ...
  [
    ...
    { name: "Netlify", icon: "https://www.vectorlogo.zone/logos/netlify/netlify-icon.svg", url: "https://netlify.com" },
    { name: "Render", icon: "https://www.svgrepo.com/show/354528/render.svg", url: "https://render.com" },
